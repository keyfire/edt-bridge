...
public final class DebugEvaluateTool {
    ...
    public JsonObject descriptor() {
        ...
        t.addProperty("descriptionRu",
                ...
                + "это исполнение произвольного кода против живой ИБ. Самая жёсткая защита: нужен токен И "
                + "allowCodeExecution=true И серверный переключатель EDT_BRIDGE_ALLOW_EVALUATE=1 (по умолчанию "
                + "выключено). ТОЛЬКО СТЕНД, никогда не рабочая база. Сначала приостановите поток "
