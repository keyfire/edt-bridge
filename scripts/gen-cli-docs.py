...
SRC = ROOT / "python" / "src"
COMMANDS = ["call", "tools", "status", "shutdown", "gui", "plugins", "self-update"]

TEXT = {
    "ru": {
        "title": "Команды",
        "desc": "Справочник команд обвязки edt-bridge-mcp: вызов инструмента из командной строки, список инструментов, состояние моста и самообновление.",
        "label": "Команды",
        "order": 5,
        "intro": (
